     ...
     <div id="{{$entry['site']->id}}" class="site-row" style="clear:both; border: 1px solid black; margin: 20px;">
       ...
       <div style="width:100%; display:none;" class="sub-row" id="{{$entry['site']->id}}">
         <table style="width: 100%; border: 1px solid black;">
            <th style="width: 33%; text-align: center;"><strong>Practicum Plan Titles</strong></th>
            <th style="width: 33%; text-align: center;"><strong>Work Terms</strong></th>
            <th style="width: 33%; text-align: center;"><strong>Departments/Tracks</strong></th>
